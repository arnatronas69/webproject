          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="home"><span class="fw-bold text-uppercase text-dark">Boutique</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                  <!-- Link--><a class="nav-link active" href="shop/">Shop</a>
                </li>
                <li class="nav-item">
              ...
              <ul class="navbar-nav ms-auto">               
                <li class="nav-item"><a class="nav-link" href="cart"> <i class="fas fa-dolly-flatbed me-1 text-gray"></i>Cart<small class="text-gray fw-normal"id = "cart-count">(2)</small></a></li>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 order-2 order-lg-1">
                ...
                <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                  <li class="mb-2"><a class="reset-anchor" href="https://www.google.com/search?q=eggs&client=firefox-b-d&source=lnms&tbm=isch&sa=X&ved=2ahUKEwietu6u2_f-AhXS-yoKHUlxC9UQ_AUoAXoECAEQAw&biw=1920&bih=919#imgrc=4lSaAwZUpuDZ4M">kiausiniai</a></li>
              ...
              <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                <div class="row mb-3 align-items-center">
                  <div class="col-lg-6 mb-2 mb-lg-0">
                    <p class="text-sm text-muted mb-0">Showing 1–{{ count($products) }} of {{ count($products) }} results</p>
                  </div>
                  <div class="col-lg-6">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                  <div class="product text-center">
                    <div class="position-relative mb-3">
                      ...
                      <a class="d-block" href="{{ route('product.show', ['id' => $product->id]) }}">
                        <img class="img-fluid w-100" src="img/product-{{ rand(1, 12) }}.jpg" alt="...">
                      </a>
                    ...
                    <h6>
                      <a class="reset-anchor" href="{{ route('product.show', ['id' => $product->id]) }}">{{ $product->name }}</a>
                    </h6>
