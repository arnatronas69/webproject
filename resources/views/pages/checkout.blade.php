              ...
              <form action="#">
                <div class="row gy-3">
                  <div class="col-lg-6">
                    ...
                    <input class="form-control form-control-lg" type="text" id="firstName" name="first_name" placeholder="Enter your first name">
                  </div>
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="lastName">Last name </label>
                    <input class="form-control form-control-lg" type="text" id="lastName" name="last_name" placeholder="Enter your last name">
                  </div>
                  <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
                    ...
                    <input class="form-control form-control-lg" type="tel" id="phone" name="phone_number" placeholder="e.g. +02 245354745">
                  </div>
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="company">Company name (optional) </label>
                    <input class="form-control form-control-lg" type="text" id="company" name="company_name" placeholder="Your company name">
                  </div>
                  ...
                  <div class="col-lg-12">
                    ...
                    <input class="form-control form-control-lg" type="text" id="address" name="address_line_1" placeholder="House number and street name">
                  </div>
                  <div class="col-lg-12">
                    <label class="form-label text-sm text-uppercase" for="addressalt">Address line 2 </label>
                    <input class="form-control form-control-lg" type="text" id="addressalt" name="address_line_2" placeholder="Apartment, Suite, Unit, etc (optional)">
                  </div>
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="city">Town/City </label>
                    <input class="form-control form-control-lg" type="text" id="city" name="town_city">
                  </div>
                  <div class="col-lg-6">
                ...
                <div class="card-body">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="d-flex align-items-center justify-content-between">
                      <strong class="small fw-bold">{{ $cartItem->product->name }}</strong>
                      <span class="text-muted small">${{ $cartItem->product->price }}</span>
                    </li>
