          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="home"><span class="fw-bold text-uppercase text-dark">Boutique</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                  <!-- Link--><a class="nav-link active" href="detail">Product detail</a>
                </li>
        ...
        <div class="container">
          <div class="row mb-5">
            ...
            <div class="col-lg-6">
              ...
              <h1>{{ $product->name }}</h1>
              <p class="text-muted lead">Price: ${{ $product->price }}</p>
              <p class="text-sm mb-4">{{ $product->description }}</p>
              ...
              <ul class="list-unstyled small d-inline-block">
                ...
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Category:</strong><a class="reset-anchor ms-2" href="#!">{{ $category->name }}</a></li>
                @foreach ($tags as $tag)
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Tags:</strong>
                    <a class="reset-anchor ms-2" href="#!">{{ $tag->name }}</a></li>
                @endforeach
              </ul>
            </div>
          </div>
...
<div class="col-lg-3 col-sm-6">
  <div class="product text-center skel-loader">
    <div class="d-block mb-3 position-relative"><a class="d-block" href="{{ route('product.show', $relatedProduct->id) }}"><img class="img-fluid w-100" src="img/product-{{ $relatedProduct->id }}.jpg" alt="..."></a>
    ...
    <h6><a class="reset-anchor" href="{{ route('product.show', $relatedProduct->id) }}">{{ $relatedProduct->name }}</a></h6>
